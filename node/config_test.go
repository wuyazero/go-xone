...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gox1.ipc", false, filepath.Join(os.TempDir(), "gox1.ipc")},
		{"data", "gox1.ipc", false, "data/gox1.ipc"},
		{"data", "./gox1.ipc", false, "./gox1.ipc"},
		{"data", "/gox1.ipc", false, "/gox1.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gox1.ipc", true, `\\.\pipe\gox1.ipc`},
		{"data", "gox1.ipc", true, `\\.\pipe\gox1.ipc`},
		{"data", `\\.\pipe\gox1.ipc`, true, `\\.\pipe\gox1.ipc`},
	}
