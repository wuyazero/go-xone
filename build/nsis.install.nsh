Name "gox1 ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/wuyazero/go-xone/issues"
!define UPDATEURL "https://github.com/wuyazero/go-xone/releases"
!define ABOUTURL "https://github.com/wuyazero/go-xone#xonechain-go"
...
# Install gox1 binary
Section "GoX1" GOX1_IDX
  SetOutPath $INSTDIR
  file {{.GoX1}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gox1.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gox1.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "GoX1 incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "GoX1 outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "GoX1 UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "GoX1 incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\gox1.exe" "" "" "Xonechain" 30303 "" "" ""
  SimpleFC::AdvAddRule "GoX1 outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\gox1.exe" "" "" "Xonechain" "" 30303 "" ""
  SimpleFC::AdvAddRule "GoX1 UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\gox1.exe" "" "" "Xonechain" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/xonechain/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\gox1.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\gox1.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${GOX1_IDX}
    SectionGetSize ${GOX1_IDX} $0
